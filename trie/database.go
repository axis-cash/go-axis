...
type Database struct {
	diskdb axisdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb axisdb.Database) *Database {
	return &Database{
		diskdb:    diskdb,
...
func (db *Database) commit(hash common.Hash, batch axisdb.Batch) error {
