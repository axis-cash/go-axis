...
// PeerInfo represents a short summary of the Axis sub-protocol metadata known
...
// Handshake executes the axis protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("axis/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Axis sub-protocol.
type peerSet struct {
