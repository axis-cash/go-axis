...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (axis/61) or header (axis/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (axis/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both axis/61 and axis/62)
}
