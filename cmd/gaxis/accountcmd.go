...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    gaxis account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    gaxis account import [options] <keyfile>
...
func accountCreate(ctx *cli.Context) error {
	cfg := axisConfig{Node: defaultNodeConfig()}
	// Load config file.
