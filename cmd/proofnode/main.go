...
func initConfig() (string, *proofservice.Config, rpc.HTTPTimeouts) {
	...
	var (
		...
		zinFee   = flag.String("zinFee", "0axis", "zinFee")
		oinFee   = flag.String("oinFee", "0axis", "oinFee")
		outFee   = flag.String("outFee", "0axis", "outFee")
		fixedFee = flag.String("fee", "0axis", "outFee")

		pkrString = flag.String("pkr", "0axis", "outFee")
