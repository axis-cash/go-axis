...
import (
	...
	"github.com/axis-cash/go-axis/common/compiler"
...
var (
	...
	abiFlag = cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the Axis contract ABI json to bind, - for STDIN",
	}
	binFlag = cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the Axis contract bytecode (generate deploy method)",
	}
	...
	solFlag = cli.StringFlag{
		Name:  "sol",
		Usage: "Path to the Axis contract Solidity source to build and bind",
	}
