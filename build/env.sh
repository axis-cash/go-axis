...
if [ "Darwin" == "$SNAME" ]
then
    rm -rf $root/../go-axis-import/czero/lib/*
    cd "$root/../go-axis-import/czero"
    cp -rf lib_DARWIN_AMD64/* lib/
    DYLD_LIBRARY_PATH="../go-axis-import/czero/lib_DARWIN_AMD64"
...
then
   ...
   LD_LIBRARY_PATH="../go-axis-import/czero/lib_LINUX_AMD64_V3"
...
then
    ...
    LD_LIBRARY_PATH="../go-axis-import/czero/lib_LINUX_AMD64_V4"
    export LD_LIBRARY_PATH
elif [ "$SNAME" == "Linux-*" ]
then
