...
// AccountAddress represents an Axis account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address address.PKAddress `json:"address"` // Axis account address derived from the key
	Tk      address.TKAddress `json:"tk"`      // Axis account tk derived from the key
