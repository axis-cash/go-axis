...
import "github.com/axis-cash/go-axis/accounts/abi"
...
import (
	...
	"github.com/axis-cash/go-axis/accounts/abi/bind"
...
{{range $contract := .Contracts}}
	...
	{{range .Events}}
		...
		type {{$contract.Type}}{{.Normalized.Name}}Iterator struct {
			...
			sub  axis.Subscription     // Subscription for errors, completion and termination
