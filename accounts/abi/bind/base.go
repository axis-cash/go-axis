...
import (
	...
	"github.com/axis-cash/go-axis/accounts/abi"
...
// valid Axis transaction.
type TransactOpts struct {
	From      common.Address // Axis account to send the transaction from
...
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Axis blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct Axis methods
...
func (c *BoundContract) Call(opts *CallOpts, result interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = axis.CallMsg{From: opts.From, To: &c.address, Data: input}
