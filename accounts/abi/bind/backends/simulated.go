...
type SimulatedBackend struct {
	database   axisdb.Database  // In memory database to store our testing data
	blockchain *core.BlockChain // Axis blockchain to handle the consensus
...
func NewSimulatedBackend(alloc core.GenesisAlloc) *SimulatedBackend {
	database := axisdb.NewMemDatabase()
...
func (b *SimulatedBackend) BalanceAt(ctx context.Context, contract common.Address, blockNumber *big.Int) (*big.Int, error) {
	...
	statedb, _ := b.blockchain.State()
	return statedb.GetBalance(contract, "axis"), nil
}
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call axis.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call axis.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call axis.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call axis.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
	...
	from.SetBalance("axis", math.MaxBig256)
	// Execute the call.
	msg := callmsg{call}
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query axis.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query axis.FilterQuery, ch chan<- types.Log) (axis.Subscription, error) {
...
func (fb *filterBackend) ChainDb() axisdb.Database { return fb.db }
