...
type ContractCaller interface {
	...
	// input.
	CallContract(ctx context.Context, call axis.CallMsg, blockNumber *big.Int) ([]byte, error)
}
...
type PendingContractCaller interface {
	...
	PendingCallContract(ctx context.Context, call axis.CallMsg) ([]byte, error)
}
...
type ContractFilterer interface {
	...
	FilterLogs(ctx context.Context, query axis.FilterQuery) ([]types.Log, error)

	// SubscribeFilterLogs creates a background log filtering operation, returning
	// a subscription immediately, which can be used to stream the found events.
	SubscribeFilterLogs(ctx context.Context, query axis.FilterQuery, ch chan<- types.Log) (axis.Subscription, error)
}
