...
func newTester(t *testing.T, confOverride func(*axis.Config)) *tester {
	...
	ethConf := &axis.Config{
		...
		Axisbase: common.Base58ToAddress(testAddress),
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return axis.New(ctx, ethConf) }); err != nil {
