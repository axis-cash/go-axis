...
// package web3ext contains gaxis specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
		new web3._extend.Method({
			name: 'getSzkAccounts',
			call: 'axis_getSzkAccounts',
			params: 0
		}),
		new web3._extend.Method({
			name: 'genOldIndexPKr',
			call: 'axis_genOldIndexPKr',
			params: 2
		}),
		new web3._extend.Method({
			name: 'sign',
		...
		new web3._extend.Method({
			...
			call: 'axis_signTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'submitTransaction',
			call: 'axis_submitTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
        new web3._extend.Method({
			name: 'getBlockTotalRewardByNumber',
			call: 'axis_getBlockTotalRewardByNumber',
			params: 1,
       ...
       new web3._extend.Method({
			...
			call: 'axis_getBlockPosRewardByNumber',
			params: 1,
            inputFormatter: [web3._extend.utils.toHex],
			outputFormatter: web3._extend.utils.toDecimal
		}),
		new web3._extend.Method({
			...
			call: 'axis_getRawTransactionByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getRawTransactionFromBlock',
			call: function(args) {
				return (web3._extend.utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'axis_getRawTransactionByBlockHashAndIndex' : 'axis_getRawTransactionByBlockNumberAndIndex';
			},
			params: 2,
        ...
        new web3._extend.Method({
			name: 'packMethod',
            call: 'axis_packMethod',	
			params:4
		}),
       new web3._extend.Method({
			name: 'packConstruct',
            call: 'axis_packConstruct',	
			params: 3
		}),
       new web3._extend.Method({
			name: 'unPack',
	...
	properties: [
		new web3._extend.Property({
			...
			getter: 'axis_pendingTransactions',
